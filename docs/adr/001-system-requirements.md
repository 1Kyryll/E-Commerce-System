...
- **System Design** - make right design decisions to ensure system's *Scalability, Durability and Availability* under huge amount of traffic(from load testing) and meet the SLOs. 