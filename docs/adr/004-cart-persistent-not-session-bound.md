...
**Decision.** According to [System Requirements](../system-requirements.md.md), `Cart` must be persistent. Therefore, every add-to-cart request is saved to the `cart` table keyed by `User ID`.
