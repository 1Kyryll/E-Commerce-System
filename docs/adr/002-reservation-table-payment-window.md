...
**Decision.** We need a Reservations table in order to provide explicit and queryable reservations lifecycle. We rely on the reservations and not the absence of the inventory. Each reservation comes with a *15 minute TTL*.
